...
public class CodeAnalysisIssueDeserializer {
    ...
    /**
     * This method creates a new issue object from
     * the corresponding JsonElement
     *
     * @param jsonElement
     ...
     * <p>
     * Currently, a single list of issue objects is compiled from
     * all the different sections in .coafile
     * @TODO The section information may be useful in further versions of the plugin
     */
    private static class ExtractCodeAnalysisIssuesFromJson implements JsonDeserializer<List<CodeAnalysisIssue>> {
        @Override
        public List<CodeAnalysisIssue> deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
